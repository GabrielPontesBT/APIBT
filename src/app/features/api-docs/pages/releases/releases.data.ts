...
const RELEASE_MODULE_LABELS: Record<string, string> = {
  ...
  BTCashManagement: 'CASH Management',
  BTClientes: 'Clientes',
  BTConfiguracion: 'Configuracion',
  BTConfiguracionBantotal: 'Configuracion Bantotal',
  ...
  BTPersonas: 'Personas',
  BTPrecios: 'Precios',
  BTPrestamos: 'Prestamos',
  BTReglasNegocio: 'Reglas de Negocio',
  BTSegurosVoluntarios: 'Seguros Voluntarios',
  BTSNP: 'SNP',
  BTTarjetaDebito: 'Tarjeta de Debito',
  BTTarjetasDebito: 'Tarjetas de Debito',
  BTTarjetasDeDebito: 'Tarjetas de Debito',
  BTTitulos: 'Titulos',
  BTUsuarios: 'Usuarios',
  BTWorkflow: 'Workflow'
};
