...
::: note Método para realizar un desbloqueo de tarjeta.

**Nombre publicación:** BTPayCaddy.DesbloqueoTarjeta
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   <SOAP-ENV:Body>
      <BTPayCaddy.DesbloqueoTarjetaResponse xmlns="http://uy.com.dlya.bantotal/BTSOA/">
         <Btinreq>
         ...
         <Btoutreq>
            ...
            <Servicio>BTPayCaddy.DesbloqueoTarjeta</Servicio>
            <Requerimiento>1</Requerimiento>
            <Canal>BTDIGITAL</Canal>
         </Btoutreq>
      </BTPayCaddy.DesbloqueoTarjetaResponse>
   </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
```
::: 
