...
:--------- | :----------- | :-----------
sBTCSServiceDefinition | Array | Lista de servicios disponibles.
...
Nombre | Tipo | Comentarios
:--------- | :----------- | :-----------
lockingTransactionId | String |
serviceDescription | String |
lockingModuleId | String |
paymentTransactionId | String |
paymentOrCollection | String |
serviceGroupId | String |
waitForHeader | String |
serviceId | String |
origin | String |
paymentModuleId | String |
:::
<!-- CIERRA SDT -->
