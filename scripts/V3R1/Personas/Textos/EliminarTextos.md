...
sbtTextos | [sBTTextoPersona](#sBTTextoPersona) | Listado de textos de la persona.
...
```json
curl -X POST \
  'http://btd-bantotal.eastus2.cloudapp.azure.com:4462/btdeveloper/servlet/com.dlya.bantotal.odwsbt_BTPersonas_v1?EliminarTextos' \
