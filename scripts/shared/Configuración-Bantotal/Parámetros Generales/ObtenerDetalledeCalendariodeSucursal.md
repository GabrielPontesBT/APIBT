...
```json
curl -X POST \
  'http://btd-bantotal.eastus2.cloudapp.azure.com:4462/btdeveloper/servlet/com.dlya.bantotal.odwsbt_BTConfiguracionBantotal?ObtenerDetalleCalendarioDeSucursal' \
  ...
  -d '{
    "Btinreq": {
        ...
        "Requerimiento": 1,
        "Usuario": "BANTOTAL",
        "Token": "1749872094F955E77534D3E0",
        "Device": "AC"
    },
    "sucursalId": 1,
