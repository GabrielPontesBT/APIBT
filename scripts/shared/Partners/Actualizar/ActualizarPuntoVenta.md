...
::: note Método para actualizar un punto de venta de un Partner.
...
:--------- | :----------- | :-----------
sdtPuntoVenta | [sBTPuntoVenta](#sbtpuntoventa) | Datos del punto de venta.
...
Código | Descripción
:--------- | :-----------
30001  | Debe ingresar el identificador del vendedor.
30002  | El identificador del Partner no puede ser vacío.
30003  | Debe ingresar la descripción del punto de venta.
40003  | El Partner no tiene un punto de venta con el identificador que se quiere modificar.
40011  | El código de comisión no existe.
40012  | La sucursal no existe.
:::
...
habilitado | String | Indica si el punto de venta está habilitado (S: Si, N: No).
