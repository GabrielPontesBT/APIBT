...
30002 | No se recibió el identificador de cuenta.
::: 
...
fechaAlta | Date | Fecha de alta de la tarjeta.
fechaVencimiento | Date | Fecha de vencimiento de la tarjeta. 
limites | [sBDLimitesTarjeta](#sbdlimitestarjeta) | Listado de límites de la tarjeta. 
nombreTarjeta | String | Nombre de la tarjeta. 
novedadPendiente | String | ¿Tienen novedad pendiente? (S/N).
